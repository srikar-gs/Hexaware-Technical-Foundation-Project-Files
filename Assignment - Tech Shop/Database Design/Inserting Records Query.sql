...
VALUES
    ...
    (2, 'Jane', 'Smith', 'jane.smith@example.com', '456-789-0123', '456 Elm St, Anycity, USA'),
    (3, 'Michael', 'Johnson', 'michael.johnson@example.com', '789-012-3456', '789 Oak St, Anystate, USA'),
    (4, 'Emily', 'Brown', 'emily.brown@example.com', '321-654-9870', '321 Maple St, Anyvillage, USA'),
    (5, 'Daniel', 'Martinez', 'daniel.martinez@example.com', '654-987-0123', '654 Cedar St, Anysuburb, USA'),
    (6, 'Sarah', 'Wilson', 'sarah.wilson@example.com', '987-012-3456', '987 Pine St, Anyhamlet, USA'),
    (7, 'David', 'Taylor', 'david.taylor@example.com', '111-222-3333', '111 Oak St, Anycity, USA'),
    (8, 'Olivia', 'Anderson', 'olivia.anderson@example.com', '444-555-6666', '444 Elm St, Anystate, USA'),
    (9, 'James', 'Hernandez', 'james.hernandez@example.com', '777-888-9999', '777 Maple St, Anytown, USA'),
    (10, 'Emma', 'Garcia', 'emma.garcia@example.com', '000-111-2222', '000 Cedar St, Anyvillage, USA'),
    (11, 'Ava', 'Lopez', 'ava.lopez@example.com', '333-444-5555', '333 Pine St, Anysuburb, USA'),
    (12, 'Alexander', 'Martinez', 'alexander.martinez@example.com', '666-777-8888', '666 Oak St, Anyhamlet, USA'),
    (13, 'Sophia', 'Gonzalez', 'sophia.gonzalez@example.com', '999-000-1111', '999 Elm St, Anytown, USA'),
    (14, 'Mia', 'Perez', 'mia.perez@example.com', '222-333-4444', '222 Maple St, Anycity, USA'),
    (15, 'Logan', 'Rodriguez', 'logan.rodriguez@example.com', '555-666-7777', '555 Cedar St, Anystate, USA');
...
-- Insert 15 sample records into Orders table
...
-- Insert 15 sample records into OrderDetails table
